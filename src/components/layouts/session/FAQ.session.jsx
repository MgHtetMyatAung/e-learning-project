...
export default function FAQSession({FAQ}) {
  ...
  return (
    <div className=" bg-white-1 rounded-[12px] tablet:py-[80px] tablet:px-[60px] p-[24px] gap-[3rem] grid desktop:grid-cols-5 grid-cols-1">
        ...
        <div className="col-span-3 grid gap-[20px]">
          {
            FAQ && FAQ.map((faq) => {
              return <FAQCard key={faq.id} selectedId={selectedId} selectedHandel={selectedHandel} {...faq} />;
            })
          }
        </div>
      </div>
