...
export default function PasswordInput({type = true}) {
  ...
  return (
   ...
   <div className=' flex justify-between relative input-wraper'>
      ...
      {isHide && <img src={Eye} className='w-5 desktop:w-6 inline-block cursor-pointer' onClick={hidePassword} />}
      {!isHide && <img src={HideEye} className='w-5 desktop:w-6 inline-block cursor-pointer' onClick={hidePassword} /> }
   </div>
