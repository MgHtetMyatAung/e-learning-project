  ...
  return (
    <div className="rounded-[10px] bg-white-2 border border-white-4">
      <div className="p-[30px] laptop:p-[40px] desktop:p-[50px] font-normal text-grey-5">
        <p className="text-[14px] laptop:text-[16px] desktop:text-[18px] leading-[24px] desktop:leading-[27px]">
      ...
      <div className="flex justify-between desktop:py-[30px] desktop:px-[50px] laptop:py-[24px] laptop:px-[40px] py-[20px] px-[30px] items-center">
        <div className="flex items-center">
          ...
          <span className="font-semibold tablet:text-md text-grey-6 text-[16px] desktop:text-[18px] leading-[24px] desktop:leading-[27px] text-nowrap">
            Sarah L
          </span>
        </div>

        <div>
          <button className="rounded-[8px] bg-white-3 border border-white-4 py-[14px] px-[16px] desktop:py-[18px] desktop:px-[24px] font-medium align-middle text-[14px] desktop:text-[18px] leading-[21px] desktop:leading-[27px] text-nowrap">
            Read Full Story
          </button>
        </div>
      </div>
